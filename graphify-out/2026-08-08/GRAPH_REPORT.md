...
## Summary
- 760 nodes · 1271 edges · 73 communities (58 shown, 15 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 13 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `1e004fc9`
...
### Community 0 - "react"
Cohesion: 0.06
Nodes (14): App(), BreezySunMoonWidget(), DetailDrawer(), getWeatherIcon(), HourlyCarousel(), REGIONES, SatelliteModal(), WeatherHeader() (+6 more)
...
### Community 10 - "sincronizador_background.py"
Cohesion: 0.27
...
### Community 12 - "finalize_pet_run.py"
Cohesion: 0.33
...
### Community 15 - "extract_strip_frames.py"
Cohesion: 0.31
...
### Community 16 - "record_imagegen_result.py"
Cohesion: 0.35
...
### Community 22 - "inspect_frames.py"
Cohesion: 0.35
...
### Community 33 - "asset-harvest.mjs"
Cohesion: 0.28
Nodes (3): downloadAll(), localPathFor(), safeName()

### Community 34 - "mapa.js"
Cohesion: 0.58
...
### Community 35 - "remotion-template/package.json"
Cohesion: 0.25
...
### Community 38 - "obsidian/.obsidian/app.json"
Cohesion: 0.25
...
### Community 50 - "goes_processor.py"
Cohesion: 0.40
...
### Community 54 - "checker"
Cohesion: 0.67
Nodes (3): checker(), main(), Image

### Community 55 - "alpha_nonzero_count"
Cohesion: 0.67
...
- **Why does `react` connect `react` to `BubbleScene.tsx`, `.oxlintrc.json`?**
  _High betweenness centrality (0.009) - this node is a cross-community bridge._
- **Why does `devDependencies` connect `devDependencies` to `frontend/package.json`, `devDependencies`?**
  _High betweenness centrality (0.004) - this node is a cross-community bridge._
- **Why does `dependencies` connect `dependencies` to `dependencies`, `frontend/package.json`?**
