...
3. `main()` - 15 edges
4. `obtener_clima_hiperlocal()` - 11 edges
5. `main()` - 11 edges
...
### Community 5 - "main.py"
Cohesion: 0.19
Nodes (21): get, buscar_estaciones(), calcular_calidad_aire_dual(), calcular_distancia(), calcular_horas_frio(), calcular_rumbo_cardinal(), construir_transparency_metadata(), evaluar_inversion_termica() (+13 more)

### Community 6 - "GEECore"
Cohesion: 0.19
Nodes (13): GEECore, extraer_historico_ndvi(), extraer_metricas_agricolas(), fallback_rural(), Extrae serie de tiempo NDVI de los últimos 12 meses usando MODIS MOD13Q1., Extrae métricas satelitales (Sentinel-2, ERA5, MODIS) orientadas a la…, _create_tile_url(), obtener_capas_gee_y_windy() (+5 more)
...
Cohesion: 0.25
Nodes (17): AsyncClient, forzar_sincronizacion_manual(), post, cargar_catalogo_maestro(), clean_num(), ejecutar_sincronizacion_completa(), guardar_cache_en_disco(), iniciar_loop_background() (+9 more)
...
### Community 18 - "cache_store.py"
Cohesion: 0.21
Nodes (12): Any, load_cache(), _load_local(), Persistencia de la caché compartida entre el job y las instancias API., Carga la instantánea central; en desarrollo usa el archivo local., Guarda una instantánea completa. Reemplazar un objeto GCS es atómico., save_cache(), _save_local() (+4 more)
...
### Community 20 - "inspect_frames.py"
Cohesion: 0.35
...
### Community 21 - "cargar_cache_desde_disco"
Cohesion: 0.17
Nodes (12): FastAPI, lifespan(), Inicializa dependencias; la sincronización productiva la realiza Cloud Run Job., refresh_cache_before_api(), middleware, Request, cargar_cache_desde_disco(), Carga la caché local o compartida sin reemplazar su referencia global. (+4 more)

### Community 22 - "interaction-probe.mjs"
Cohesion: 0.24
