...
## Summary
- 761 nodes · 1272 edges · 80 communities (61 shown, 19 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 13 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `85daadcb`
...
### Community 0 - "prepare_chat_overlay_bundle.py"
Cohesion: 0.16
...
### Community 3 - "BubbleScene.tsx"
Cohesion: 0.15
Nodes (17): chatSpec, AvatarImage(), avatarSrcFor(), PRESET_FILES, Bubble(), BubbleScene(), bubbleWidthFor(), CONTAINER_THEME (+9 more)

### Community 4 - "main.py"
Cohesion: 0.17
Nodes (24): get, buscar_estaciones(), calcular_calidad_aire_dual(), calcular_distancia(), calcular_horas_frio(), calcular_rumbo_cardinal(), calcular_triangulacion_idw(), construir_transparency_metadata() (+16 more)
...
### Community 9 - "sincronizador_background.py"
Cohesion: 0.27
Nodes (16): AsyncClient, forzar_sincronizacion_manual(), post, cargar_catalogo_maestro(), clean_agromet_num(), clean_num(), ejecutar_sincronizacion_completa(), guardar_cache_en_disco() (+8 more)
...
### Community 18 - "mirror-site.mjs"
Cohesion: 0.14
Nodes (10): all, args, failed, outRoot, ownUrls, pw, responses, siteDir (+2 more)

### Community 19 - "cargar_cache_desde_disco"
Cohesion: 0.16
Nodes (13): FastAPI, lifespan(), Inicializa dependencias; la sincronización productiva la realiza Cloud Run Job., refresh_cache_before_api(), middleware, Request, cargar_cache_desde_disco(), iniciar_loop_background() (+5 more)
...
### Community 21 - "inspect_frames.py"
Cohesion: 0.35
...
### Community 23 - "interaction-probe.mjs"
Cohesion: 0.24
...
### Community 34 - "asset-harvest.mjs"
Cohesion: 0.28
Nodes (3): downloadAll(), localPathFor(), safeName()

### Community 35 - "mapa.js"
Cohesion: 0.58
...
### Community 36 - "remotion-template/package.json"
Cohesion: 0.25
...
### Community 39 - "obsidian/.obsidian/app.json"
Cohesion: 0.25
...
### Community 41 - "WeatherContext.jsx"
Cohesion: 0.32
Nodes (4): App(), FALLBACK_CLIMA_DATA, WeatherContext, WeatherProvider()

### Community 42 - ".obsidian/app.json"
Cohesion: 0.25
Nodes (7): alwaysUpdateLinks, foldHeading, foldIndent, showFrontmatter, showLineNumber, tabSize, useMarkdownLinks
...
### Community 53 - "SatelliteModal.jsx"
Cohesion: 0.60
Nodes (3): SatelliteModal(), WeatherHeader(), formatLocalTime()

### Community 54 - "goes_processor.py"
Cohesion: 0.40
...
### Community 60 - "alpha_nonzero_count"
Cohesion: 0.67
Nodes (3): alpha_nonzero_count(), main(), Image

## Knowledge Gaps
- **98 isolated node(s):** `$schema`, `oxc`, `react/rules-of-hooks`, `warn`, `name` (+93 more)
...
- **Why does `react` connect `react` to `HourlyCarousel.jsx`, `BubbleScene.tsx`, `LocationFallbackModal.jsx`, `.oxlintrc.json`, `WeatherContext.jsx`, `SatelliteModal.jsx`, `App.jsx`, `DetailDrawer.jsx`, `AgroPanel.jsx`?**
